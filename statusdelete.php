...
fstatusdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($status->code->Visible) { // code ?>
		<th class="<?php echo $status->code->HeaderCellClass() ?>"><span id="elh_status_code" class="status_code"><?php echo $status->code->FldCaption() ?></span></th>
<?php } ?>
<?php if ($status->description->Visible) { // description ?>
		<th class="<?php echo $status->description->HeaderCellClass() ?>"><span id="elh_status_description" class="status_description"><?php echo $status->description->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($status->code->Visible) { // code ?>
		<td<?php echo $status->code->CellAttributes() ?>>
<span id="el<?php echo $status_delete->RowCnt ?>_status_code" class="status_code">
...
<?php } ?>
<?php if ($status->description->Visible) { // description ?>
		<td<?php echo $status->description->CellAttributes() ?>>
<span id="el<?php echo $status_delete->RowCnt ?>_status_description" class="status_description">
