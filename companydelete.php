...
<?php if ($company->id->Visible) { // id ?>
		<th class="<?php echo $company->id->HeaderCellClass() ?>"><span id="elh_company_id" class="company_id"><?php echo $company->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($company->description->Visible) { // description ?>
		<th class="<?php echo $company->description->HeaderCellClass() ?>"><span id="elh_company_description" class="company_description"><?php echo $company->description->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $company_delete->RowCnt ?>_company_id" class="company_id">
...
<?php } ?>
<?php if ($company->description->Visible) { // description ?>
		<td<?php echo $company->description->CellAttributes() ?>>
<span id="el<?php echo $company_delete->RowCnt ?>_company_description" class="company_description">
