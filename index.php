...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'department'))
			$this->Page_Terminate("departmentlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'leave_form'))
			$this->Page_Terminate("leave_formlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'status'))
			$this->Page_Terminate("statuslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'user_profile'))
			$this->Page_Terminate("user_profilelist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'leave_type'))
			$this->Page_Terminate("leave_typelist.php");
