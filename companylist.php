...
class ccompany_list extends ccompany {
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server" && isset($UserProfile))
			$sSavedFilterList = $UserProfile->GetSearchFilters(CurrentUserName(), "fcompanylistsrch");
...
<?php } ?>
<?php if ($company_list->TotalRecs > 0 && (!$company_list->AutoHidePageSizeSelector || $company_list->Pager->Visible)) { ?>
<div class="ewPager">
<input type="hidden" name="t" value="company">
<select name="<?php echo EW_TABLE_REC_PER_PAGE ?>" class="form-control input-sm ewTooltip" title="<?php echo $Language->Phrase("RecordsPerPage") ?>" onchange="this.form.submit();">
<option value="10"<?php if ($company_list->DisplayRecs == 10) { ?> selected<?php } ?>>10</option>
<option value="20"<?php if ($company_list->DisplayRecs == 20) { ?> selected<?php } ?>>20</option>
<option value="50"<?php if ($company_list->DisplayRecs == 50) { ?> selected<?php } ?>>50</option>
<option value="100"<?php if ($company_list->DisplayRecs == 100) { ?> selected<?php } ?>>100</option>
<option value="ALL"<?php if ($company->getRecordsPerPage() == -1) { ?> selected<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
...
<?php if ($company->id->Visible) { // id ?>
	<?php if ($company->SortUrl($company->id) == "") { ?>
		<th data-name="id" class="<?php echo $company->id->HeaderCellClass() ?>"><div id="elh_company_id" class="company_id"><div class="ewTableHeaderCaption"><?php echo $company->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id" class="<?php echo $company->id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $company->SortUrl($company->id) ?>',1);"><div id="elh_company_id" class="company_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $company->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($company->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($company->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($company->description->Visible) { // description ?>
	<?php if ($company->SortUrl($company->description) == "") { ?>
		<th data-name="description" class="<?php echo $company->description->HeaderCellClass() ?>"><div id="elh_company_description" class="company_description"><div class="ewTableHeaderCaption"><?php echo $company->description->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="description" class="<?php echo $company->description->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $company->SortUrl($company->description) ?>',1);"><div id="elh_company_description" class="company_description">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $company->description->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($company->description->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($company->description->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($company->id->Visible) { // id ?>
		<td data-name="id"<?php echo $company->id->CellAttributes() ?>>
<span id="el<?php echo $company_list->RowCnt ?>_company_id" class="company_id">
<span<?php echo $company->id->ViewAttributes() ?>>
<?php echo $company->id->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($company->description->Visible) { // description ?>
		<td data-name="description"<?php echo $company->description->CellAttributes() ?>>
<span id="el<?php echo $company_list->RowCnt ?>_company_description" class="company_description">
<span<?php echo $company->description->ViewAttributes() ?>>
<?php echo $company->description->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
