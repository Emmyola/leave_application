...
<?php if ($company->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_company_id" class="<?php echo $company_edit->LeftColumnClass ?>"><?php echo $company->id->FldCaption() ?></label>
		<div class="<?php echo $company_edit->RightColumnClass ?>"><div<?php echo $company->id->CellAttributes() ?>>
<?php if ($company->CurrentAction <> "F") { ?>
<span id="el_company_id">
<span<?php echo $company->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $company->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="company" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($company->id->CurrentValue) ?>">
<?php } else { ?>
<span id="el_company_id">
<span<?php echo $company->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $company->id->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="company" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($company->id->FormValue) ?>">
<?php } ?>
<?php echo $company->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($company->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_company_description" for="x_description" class="<?php echo $company_edit->LeftColumnClass ?>"><?php echo $company->description->FldCaption() ?></label>
		<div class="<?php echo $company_edit->RightColumnClass ?>"><div<?php echo $company->description->CellAttributes() ?>>
<?php if ($company->CurrentAction <> "F") { ?>
...
<p class="form-control-static"><?php echo $company->description->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="company" data-field="x_description" name="x_description" id="x_description" value="<?php echo ew_HtmlEncode($company->description->FormValue) ?>">
<?php } ?>
<?php echo $company->description->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
