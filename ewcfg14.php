...
define("EW_PROJECT_NAME", "online_leave_app", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{67DBC02E-FD20-415A-8CF5-94DD09C14F7A}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'kb8CWqROvPHnDgmY', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/online_leave_app.css", TRUE); // Project stylesheet file name
...
$EW_RELATED_PROJECT_ID = "";
$EW_BODY_CLASS = "hold-transition skin-purple";
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "leave_app_db", "qs" => "`", "qe" => "`");
...
define("EW_SESSION_TIMEOUT", 20, TRUE); // Session timeout time (minutes)
...
define("EW_USER_TABLE", "`user_profile`", TRUE);
define("EW_USER_NAME_FILTER", "(`username` = '%u')", TRUE);
define("EW_USER_ID_FILTER", "(`staff_id` = %u)", TRUE);
...
// Email
define("EW_SMTP_SERVER", "smtp.sendgrid.net", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 465, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "ssl", TRUE);
define("EW_SMTP_SERVER_USERNAME", "apikey", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "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", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "noreply@groomingcentreops.org", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "info@ideas4hire.com", TRUE); // Recipient email address
