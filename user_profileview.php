...
$user_profile_view = NULL; // Initialize page object first

class cuser_profile_view extends cuser_profile {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "user_profilelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "user_profilelist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "user_profilelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($user_profile_view)) $user_profile_view = new cuser_profile_view();
...
var CurrentForm = fuser_profileview = new ew_Form("fuser_profileview", "view");

// Form_CustomValidate event
fuser_profileview.Form_CustomValidate = 
...
fuser_profileview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fuser_profileview.Lists["x_gender"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuser_profileview.Lists["x_gender"].Options = <?php echo json_encode($user_profile_view->gender->Options()) ?>;
fuser_profileview.Lists["x_marital_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuser_profileview.Lists["x_marital_status"].Options = <?php echo json_encode($user_profile_view->marital_status->Options()) ?>;
fuser_profileview.Lists["x_company"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_department"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"company"};
fuser_profileview.Lists["x_company"].Data = "<?php echo $user_profile_view->company->LookupFilterQuery(FALSE, "view") ?>";
fuser_profileview.Lists["x_department"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"department"};
fuser_profileview.Lists["x_department"].Data = "<?php echo $user_profile_view->department->LookupFilterQuery(FALSE, "view") ?>";
fuser_profileview.Lists["x_town_city"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_state_descriptions","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"states_table"};
fuser_profileview.Lists["x_town_city"].Data = "<?php echo $user_profile_view->town_city->LookupFilterQuery(FALSE, "view") ?>";
fuser_profileview.Lists["x_state_origin"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_state_descriptions","","",""],"ParentFields":[],"ChildFields":["x_local_gra"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"states_table"};
fuser_profileview.Lists["x_state_origin"].Data = "<?php echo $user_profile_view->state_origin->LookupFilterQuery(FALSE, "view") ?>";
fuser_profileview.Lists["x_local_gra"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_lga_descriptions","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"lga_states"};
fuser_profileview.Lists["x_local_gra"].Data = "<?php echo $user_profile_view->local_gra->LookupFilterQuery(FALSE, "view") ?>";
fuser_profileview.Lists["x_qualification_level"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuser_profileview.Lists["x_qualification_level"].Options = <?php echo json_encode($user_profile_view->qualification_level->Options()) ?>;
fuser_profileview.Lists["x_qualification_grade"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuser_profileview.Lists["x_qualification_grade"].Options = <?php echo json_encode($user_profile_view->qualification_grade->Options()) ?>;
fuser_profileview.Lists["x_accesslevel"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fuser_profileview.Lists["x_accesslevel"].Data = "<?php echo $user_profile_view->accesslevel->LookupFilterQuery(FALSE, "view") ?>";
fuser_profileview.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuser_profileview.Lists["x_status"].Options = <?php echo json_encode($user_profile_view->status->Options()) ?>;
...
<?php if ($user_profile->Export == "") { ?>
<div class="ewToolbar">
<?php $user_profile_view->ExportOptions->Render("body") ?>
<?php
	foreach ($user_profile_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $user_profile_view->ShowPageHeader(); ?>
<?php
$user_profile_view->ShowMessage();
?>
<form name="fuser_profileview" id="fuser_profileview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($user_profile_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $user_profile_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="user_profile">
<input type="hidden" name="modal" value="<?php echo intval($user_profile_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($user_profile->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_user_profile_id"><?php echo $user_profile->id->FldCaption() ?></span></td>
...
<?php echo $user_profile->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->staff_id->Visible) { // staff_id ?>
	<tr id="r_staff_id">
		<td class="col-sm-2"><span id="elh_user_profile_staff_id"><?php echo $user_profile->staff_id->FldCaption() ?></span></td>
...
<?php echo $user_profile->staff_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->last_name->Visible) { // last_name ?>
	<tr id="r_last_name">
		<td class="col-sm-2"><span id="elh_user_profile_last_name"><?php echo $user_profile->last_name->FldCaption() ?></span></td>
...
<?php echo $user_profile->last_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->first_name->Visible) { // first_name ?>
	<tr id="r_first_name">
		<td class="col-sm-2"><span id="elh_user_profile_first_name"><?php echo $user_profile->first_name->FldCaption() ?></span></td>
...
<?php echo $user_profile->first_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->_email->Visible) { // email ?>
	<tr id="r__email">
		<td class="col-sm-2"><span id="elh_user_profile__email"><?php echo $user_profile->_email->FldCaption() ?></span></td>
...
<?php echo $user_profile->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->gender->Visible) { // gender ?>
	<tr id="r_gender">
		<td class="col-sm-2"><span id="elh_user_profile_gender"><?php echo $user_profile->gender->FldCaption() ?></span></td>
...
<?php echo $user_profile->gender->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->marital_status->Visible) { // marital_status ?>
	<tr id="r_marital_status">
		<td class="col-sm-2"><span id="elh_user_profile_marital_status"><?php echo $user_profile->marital_status->FldCaption() ?></span></td>
...
<?php echo $user_profile->marital_status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->date_of_birth->Visible) { // date_of_birth ?>
	<tr id="r_date_of_birth">
		<td class="col-sm-2"><span id="elh_user_profile_date_of_birth"><?php echo $user_profile->date_of_birth->FldCaption() ?></span></td>
...
<?php echo $user_profile->date_of_birth->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->username->Visible) { // username ?>
	<tr id="r_username">
		<td class="col-sm-2"><span id="elh_user_profile_username"><?php echo $user_profile->username->FldCaption() ?></span></td>
...
<?php echo $user_profile->username->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->mobile->Visible) { // mobile ?>
	<tr id="r_mobile">
		<td class="col-sm-2"><span id="elh_user_profile_mobile"><?php echo $user_profile->mobile->FldCaption() ?></span></td>
...
<?php echo $user_profile->mobile->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->company->Visible) { // company ?>
	<tr id="r_company">
		<td class="col-sm-2"><span id="elh_user_profile_company"><?php echo $user_profile->company->FldCaption() ?></span></td>
...
<?php echo $user_profile->company->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->department->Visible) { // department ?>
	<tr id="r_department">
		<td class="col-sm-2"><span id="elh_user_profile_department"><?php echo $user_profile->department->FldCaption() ?></span></td>
...
<?php echo $user_profile->department->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->home_address->Visible) { // home_address ?>
	<tr id="r_home_address">
		<td class="col-sm-2"><span id="elh_user_profile_home_address"><?php echo $user_profile->home_address->FldCaption() ?></span></td>
...
<?php echo $user_profile->home_address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->town_city->Visible) { // town_city ?>
	<tr id="r_town_city">
		<td class="col-sm-2"><span id="elh_user_profile_town_city"><?php echo $user_profile->town_city->FldCaption() ?></span></td>
...
<?php echo $user_profile->town_city->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->state_origin->Visible) { // state_origin ?>
	<tr id="r_state_origin">
		<td class="col-sm-2"><span id="elh_user_profile_state_origin"><?php echo $user_profile->state_origin->FldCaption() ?></span></td>
...
<?php echo $user_profile->state_origin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->local_gra->Visible) { // local_gra ?>
	<tr id="r_local_gra">
		<td class="col-sm-2"><span id="elh_user_profile_local_gra"><?php echo $user_profile->local_gra->FldCaption() ?></span></td>
...
<?php echo $user_profile->local_gra->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->next_kin->Visible) { // next_kin ?>
	<tr id="r_next_kin">
		<td class="col-sm-2"><span id="elh_user_profile_next_kin"><?php echo $user_profile->next_kin->FldCaption() ?></span></td>
...
<?php echo $user_profile->next_kin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->resident_nxt_kin->Visible) { // resident_nxt_kin ?>
	<tr id="r_resident_nxt_kin">
		<td class="col-sm-2"><span id="elh_user_profile_resident_nxt_kin"><?php echo $user_profile->resident_nxt_kin->FldCaption() ?></span></td>
...
<?php echo $user_profile->resident_nxt_kin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->nearest_bus_stop->Visible) { // nearest_bus_stop ?>
	<tr id="r_nearest_bus_stop">
		<td class="col-sm-2"><span id="elh_user_profile_nearest_bus_stop"><?php echo $user_profile->nearest_bus_stop->FldCaption() ?></span></td>
...
<?php echo $user_profile->nearest_bus_stop->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->town_city_nxt_kin->Visible) { // town_city_nxt_kin ?>
	<tr id="r_town_city_nxt_kin">
		<td class="col-sm-2"><span id="elh_user_profile_town_city_nxt_kin"><?php echo $user_profile->town_city_nxt_kin->FldCaption() ?></span></td>
...
<?php echo $user_profile->town_city_nxt_kin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->email_nxt_kin->Visible) { // email_nxt_kin ?>
	<tr id="r_email_nxt_kin">
		<td class="col-sm-2"><span id="elh_user_profile_email_nxt_kin"><?php echo $user_profile->email_nxt_kin->FldCaption() ?></span></td>
...
<?php echo $user_profile->email_nxt_kin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->phone_nxt_kin->Visible) { // phone_nxt_kin ?>
	<tr id="r_phone_nxt_kin">
		<td class="col-sm-2"><span id="elh_user_profile_phone_nxt_kin"><?php echo $user_profile->phone_nxt_kin->FldCaption() ?></span></td>
...
<?php echo $user_profile->phone_nxt_kin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->qualification_level->Visible) { // qualification_level ?>
	<tr id="r_qualification_level">
		<td class="col-sm-2"><span id="elh_user_profile_qualification_level"><?php echo $user_profile->qualification_level->FldCaption() ?></span></td>
...
<?php echo $user_profile->qualification_level->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->qualification_grade->Visible) { // qualification_grade ?>
	<tr id="r_qualification_grade">
		<td class="col-sm-2"><span id="elh_user_profile_qualification_grade"><?php echo $user_profile->qualification_grade->FldCaption() ?></span></td>
...
<?php echo $user_profile->qualification_grade->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->upload_of_credentcial->Visible) { // upload_of_credentcial ?>
	<tr id="r_upload_of_credentcial">
		<td class="col-sm-2"><span id="elh_user_profile_upload_of_credentcial"><?php echo $user_profile->upload_of_credentcial->FldCaption() ?></span></td>
...
<?php echo ew_GetFileViewTag($user_profile->upload_of_credentcial, $user_profile->upload_of_credentcial->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($user_profile->password->Visible) { // password ?>
	<tr id="r_password">
		<td class="col-sm-2"><span id="elh_user_profile_password"><?php echo $user_profile->password->FldCaption() ?></span></td>
...
<?php echo $user_profile->password->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->accesslevel->Visible) { // accesslevel ?>
	<tr id="r_accesslevel">
		<td class="col-sm-2"><span id="elh_user_profile_accesslevel"><?php echo $user_profile->accesslevel->FldCaption() ?></span></td>
...
<?php echo $user_profile->accesslevel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_user_profile_status"><?php echo $user_profile->status->FldCaption() ?></span></td>
...
<?php echo $user_profile->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_profile->profile->Visible) { // profile ?>
	<tr id="r_profile">
		<td class="col-sm-2"><span id="elh_user_profile_profile"><?php echo $user_profile->profile->FldCaption() ?></span></td>
		<td data-name="profile"<?php echo $user_profile->profile->CellAttributes() ?>>
<span id="el_user_profile_profile">
<span<?php echo $user_profile->profile->ViewAttributes() ?>>
<?php echo $user_profile->profile->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($user_profile->Export == "") { ?>
<script type="text/javascript">
fuser_profileview.Init();
</script>
<?php } ?>
<?php
$user_profile_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($user_profile->Export == "") { ?>
...
<?php
$user_profile_view->Page_Terminate();
?>
