...
<?php if ($company->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_company_description" for="x_description" class="<?php echo $company_add->LeftColumnClass ?>"><?php echo $company->description->FldCaption() ?></label>
		<div class="<?php echo $company_add->RightColumnClass ?>"><div<?php echo $company->description->CellAttributes() ?>>
