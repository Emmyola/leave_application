...
<input type="hidden" data-table="user_profile" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($user_profile->id->CurrentValue) ?>">
<?php } else { ?>
<span id="el_user_profile_id">
<span<?php echo $user_profile->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $user_profile->id->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="user_profile" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($user_profile->id->FormValue) ?>">
<?php } ?>
...
<input type="password" data-password-generated="pgt_password" data-table="user_profile" data-field="x_password" name="x_password" id="x_password" value="<?php echo $user_profile->password->EditValue ?>" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($user_profile->password->getPlaceHolder()) ?>"<?php echo $user_profile->password->EditAttributes() ?>>
