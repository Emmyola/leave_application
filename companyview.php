...
<?php if ($company->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_company_id"><?php echo $company->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $company->id->CellAttributes() ?>>
<span id="el_company_id">
<span<?php echo $company->id->ViewAttributes() ?>>
<?php echo $company->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($company->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="col-sm-2"><span id="elh_company_description"><?php echo $company->description->FldCaption() ?></span></td>
...
<?php echo $company->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
